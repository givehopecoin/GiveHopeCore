...
CONFIGFOLDER=$(eval echo $HOME/.givehope)
CFFULLPATH=$(eval echo $CONFIGFOLDER/$CONFIG_FILE)
COIN_DAEMON='givehoped'
COIN_CLI='givehope-cli'
COIN_PATH='/usr/local/bin/'
COIN_GIT='https://github.com/GiveHopeCoin/givehope.git'
COIN_BACKUP='~/GiveHopeBackup'
COIN_TGZ=''
COIN_BOOTSTRAP_URL='https://givehopecoin.io/'
COIN_BOOTSTRAP_HASH=''
...
function purgeOldInstallation() {
    echo -e "${GREEN}Searching and removing old $COIN_NAME files and configurations and making a backup to $HOME/GiveHopeBackup if they exist ${NC}"
...
cp src/givehoped $(eval echo $COIN_PATH)
cp src/givehope-cli $(eval echo $COIN_PATH)
cp src/givehope-tx $(eval echo $COIN_PATH)
else 
cp src/givehoped /usr/bin
cp src/givehope-cli /usr/bin
cp src/givehope-tx /usr/bin
COIN_PATH=/usr/bin
fi
...
function important_information() {
 ...
 echo -e "${BLUE}================================================================================================================================${NC}"
 echo -e "${PURPLE}Windows Wallet Guide. https://github.com/GiveHope/master/README.md${NC}"
 echo -e "${BLUE}================================================================================================================================${NC}"
...
logo
 echo -e "for GiveHope with some stuff borrowed from RealBiYoda. " 
 echo -e "${BLUE}================================================================================================================================${NC}"
 echo -e "${CYAN}Ensure Node is fully SYNCED with BLOCKCHAIN.${NC}"
 echo -e "${BLUE}================================================================================================================================${NC}"
 echo -e "${GREEN}Usage Commands.${NC}"
 echo -e "${GREEN}givehope-cli masternode status${NC}"
 echo -e "${GREEN}givehope-cli getinfo.${NC}"
 echo -e "${BLUE}================================================================================================================================${NC}"
 echo -e "${RED}Donations always accepted gratefully.${NC}"
 echo -e "${BLUE}================================================================================================================================${NC}"
 echo -e "${RED}Dragon${PURPLE}Lady ${BLUE}GiveHope: ${WHITE}Wm8dAnLhcJcYuRYGBoL4NX2EepQeSBPDS3${NC}"
 echo -e "${BLUE}================================================================================================================================${NC}"
...
function important_information_wallet() {
 ...
 echo -e "${RED} ${RED}Dragon${PURPLE}Lady Flexi-compile edit $SCRIPTVER${NC}"
 echo -e "${BLUE}================================================================================================================================${NC}"
 echo -e "${PURPLE}You now have a working CLI wallet for ${BLUE}GiveHope${WHITE}!!!"
 echo -e "${BLUE}================================================================================================================================${NC}"
 echo -e "${GREEN}Configuration file is:${NC}${RED}$CFFULLPATH${NC}"
 echo -e "${GREEN}Start:${NC}${RED}systemctl start $COIN_NAME.service${NC}"
 echo -e "${GREEN}Stop:${NC}${RED}systemctl stop $COIN_NAME.service${NC}"
 ...
 echo -e "Whipped up by "
 logo
 echo -e "${YELLOW} for GiveHope with some stuff borrowed from RealBitYoda." 
 echo -e "${BLUE}================================================================================================================================${NC}"
 echo -e "${CYAN}Ensure Node is fully SYNCED with BLOCKCHAIN.${NC}"
 echo -e "${BLUE}================================================================================================================================${NC}"
 echo -e "${GREEN}Usage Commands.${NC}"
 echo -e "${GREEN}givehope-cli getinfo${NC}"
 echo -e "${GREEN}givehope-cli help${NC}"
 echo -e "${BLUE}================================================================================================================================${NC}"
 echo -e "${RED}Donations always accepted gratefully.${NC}"
 echo -e "${BLUE}================================================================================================================================${NC}"
 echo -e "${RED}Dragon${PURPLE}Lady ${BLUE}GiveHope: ${WHITE}Wm8dAnLhcJcYuRYGBoL4NX2EepQeSBPDS3 ${NC}"
...
getinfo=$(/usr/local/bin/givehope-cli getinfo)
coldlook=$(cat ~/.givehope/debug.log |grep cold)
last20=$(tail ~/.givehope/debug.log -n20)
mnstatus=$(/usr/local/bin/givehope-cli masternode status)
...
synchedstatus=$(($COIN_CLI_COMMAND |grep 'IsBlockchainSynced' |awk '{ print $2 }'))
 ...
 echo -e "${BLUE}================================================================================================================================${NC}"
 echo -e "${FgLtBlue}GiveHope ${Blink}${FgLtWhite}Support${Off}${FgLtWhite}${BgLtBlue} ${FgLtRed}Help ${Off}${FgLtWhite}${BgLtBlue}Screen"
 echo -e "${BLUE}================================================================================================================================${NC}"
echo -e  "                                                                                                          "
...
# bash <(curl https://raw.githubusercontent.com/GiveHopeCoin/GiveHopeInstaller/master/givehope_installer)
