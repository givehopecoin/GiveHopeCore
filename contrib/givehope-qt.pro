...
RESOURCES += src/qt/givehope.qrc src/qt/givehope_locale.qrc

TRANSLATIONS += src/qt/locale/givehope_bg.ts \
                src/qt/locale/givehope_de.ts \
                src/qt/locale/givehope_en.ts \
                src/qt/locale/givehope_es.ts \
                src/qt/locale/givehope_fi.ts \
                src/qt/locale/givehope_fr.ts \
                src/qt/locale/givehope_it.ts \
                src/qt/locale/givehope_ja.ts \
                src/qt/locale/givehope_pl.ts \
                src/qt/locale/givehope_pt.ts \
                src/qt/locale/givehope_ru.ts \
                src/qt/locale/givehope_sk.ts \
                src/qt/locale/givehope_sv.ts \
                src/qt/locale/givehope_vi.ts \
                src/qt/locale/givehope_zh_CN.ts \
                src/qt/locale/givehope_zh_TW.ts
