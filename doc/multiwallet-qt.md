...
In order to support loading of multiple wallets in givehope-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is givehope.cpp.
...
Changes to givehope.cpp
----------------------
givehope.cpp is the entry point into givehope-qt, and as such, will require some minor modifications to provide hooks for
...
The string parameter is just an arbitrary name given to the default wallet. It's been pre-pended with a tilde to avoid name collisions in the future with additional wallets.
