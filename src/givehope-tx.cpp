...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("GiveHope Core givehope-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  givehope-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded givehope transaction") + "\n" +
                               "  givehope-tx [options] -create [commands]   " + _("Create hex-encoded givehope transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded givehope transaction
