...
const int64_t nMinDisplayObjects = 1;
const int64_t nMaxDisplayObjects = 15;
...
enum AvailableCoinsType {
    ...
    ONLY_DENOMINATED = 2,
    ONLY_NOT10000IFMN = 3,
    ONLY_NONDENOMINATED_NOT10000IFMN = 4, // ONLY_NONDENOMINATED and not 10000 HOPC at the same time
