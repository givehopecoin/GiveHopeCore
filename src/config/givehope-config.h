/* src/config/givehope-config.h.  Generated from givehope-config.h.in by configure.  */
/* src/config/givehope-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef HOPC_CONFIG_H

#define HOPC_CONFIG_H
...
#define PACKAGE_BUGREPORT "http://www.givehopecoin.io"

/* Define to the full name of this package. */
#define PACKAGE_NAME "GiveHope Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "GiveHope Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "givehope"
