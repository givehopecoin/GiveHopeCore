...
static Checkpoints::MapCheckpoints mapCheckpoints =
	...
	(0, uint256("0x00000866f08b92c8b61bb2ac0af2c0e799e9c4b691fcba67f1413793ea005c84"));
...
public:
    CMainParams()
    {
        ...
        nDefaultPort = MAIN_DEFAULT_PORT;
	...
	nMasternodeColleteralLimxDev = 50000; //Params().MasternodeColleteralLimxDev()
        ...
        const char* pszTimestamp = "Welcome to the world GiveHope Coin, inception date Oct 18, 2018!";
        CMutableTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CScriptNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 0 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("08c2851936d2186beb85e7eaa91697284918ba6deacd4da49b56418d376a091913bde42dc868128c0ed436c184759edd0bf2a3ff32388facd6a6332e8de61c9121") << OP_CHECKSIG;
...
public:
    CTestNetParams()
    {
        ...
        vAlertPubKey = ParseHex("048ec5c51b08b683c439315cae1ce6ee553eba63d0af3e3040bc9ef72f2fb532d44585dfcbc4c718618daef3ffd887b3d033895b6fc3628abf4031390d38b37957");
        nDefaultPort = MAIN_TESTNET_PORT;
        ...
        genesis.nNonce = 26229292;

        hashGenesisBlock = genesis.GetHash();

        assert(hashGenesisBlock == uint256("0x000000ce9804f01345da72a60c9e5031ef413d59013ff12b356a5e9809347139"));
...
public:
    CRegTestParams()
    {
        ...
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 22278044;

        hashGenesisBlock = genesis.GetHash();

	nDefaultPort = TESTNET_TESTNET_PORT;

        assert(hashGenesisBlock == uint256("0x0000048d6d98d35e8f45de279585cec8be46b52325c9a9e1d40d0eee33740ef1"));
