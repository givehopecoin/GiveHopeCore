                                                                   ...
                                                                   fProxyIpValid(true)
{
    ...
    ui->displayObjects->setMinimum(nMinDisplayObjects);
    ui->displayObjects->setMaximum(nMaxDisplayObjects);
...
/* Window elements init */
    ...
    ui->theme->addItem(QString("GiveHope"), QVariant("givehope"));
...
void OptionsDialog::setModel(OptionsModel* model)
{
    ...
    connect(ui->displayObjects, SIGNAL(valueChanged(int)), this, SLOT(showRestartWarning()));
...
void OptionsDialog::setMapper()
{
    ...
    mapper->addMapping(ui->displayObjects, OptionsModel::DisplayObjects);
...
/* Window */
    ...
    mapper->addMapping(ui->anonymizeHOPC, OptionsModel::AnonymizeHOPCAmount);
