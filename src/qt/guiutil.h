...
/** Utility functions used by the HOPC Qt UI.
 */
namespace GUIUtil
{
...
// Render HOPC addresses in monospace font
...
// Parse "givehope:" URI into recipient object, return true on successful parsing
