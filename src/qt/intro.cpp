...
void Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("GiveHope Core"),
     ...
     * override -datadir in the givehope.conf file in the default data directory
     * (to be consistent with givehoped behavior)
     */
    if (dataDir != getDefaultDataDirectory())
