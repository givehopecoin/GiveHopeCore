                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("GiveHope-Coin") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a GiveHope address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and givehope: URIs)"));
...
//AAAA LimxDev Coinmix Tab	
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About GiveHope Core"), this);
    aboutAction->setStatusTip(tr("Show information about GiveHope Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for GiveHope"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your GiveHope addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified GiveHope addresses"));
    ...
    openAction->setStatusTip(tr("Open a GiveHope: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the GiveHope Core help message to get a list with possible GiveHope command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("GiveHope Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to GiveHope network", "", count));
}
...
{
    QString strTitle = tr("GiveHope Core"); // default title
