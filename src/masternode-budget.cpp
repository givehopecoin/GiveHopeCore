...
/**
    ...
    if (nHeight <= Params().LAST_POW_BLOCK())          // BLOCK: 0-200       : 180,000 Premine   TOTAL    180,000 (1%)
        nSubsidy = 0 * COIN;
    else if (nHeight >= 500 && nHeight <= 10000)       // < Block: 501       :    2970           TOTAL    182,970
        nSubsidy = 0.21 * COIN;
    else if (nHeight >= 10000 && nHeight <= 20000)     // < Block: 10001     :   25000           TOTAL    207,970
         nSubsidy = 1.75 * COIN;
    else if (nHeight >= 20000 && nHeight <= 45000)     // < Block: 20001     :  625000           TOTAL    832,970
        nSubsidy = 17.5 * COIN;
    else if (nHeight >= 45000 && nHeight <= 70000)     // < Block: 45000     : 1000000           TOTAL  1,832,970
        nSubsidy = 28 * COIN;
    else if (nHeight >= 70000 && nHeight <= 100000)    // < Block: 70000     : 2100000           TOTAL  3,932,970
        nSubsidy = 49 * COIN;
    else if (nHeight >= 100000 && nHeight <= 250000)   // < Block: 100000    : 1500000           TOTAL  5,432,970
        nSubsidy = 21 * COIN;
    else if (nHeight >= 250000 && nHeight <= 500000)   // < Block: 250000    : 2500000           TOTAL  7,932,970
        nSubsidy = 7 * COIN;
    else if (nHeight >= 500000 && nHeight <= 1000000)  // < Block: 500000    : 3500000           TOTAL 11,432,970
        nSubsidy = 4.94 * COIN;
    else
        nSubsidy = 1.75 * COIN;
