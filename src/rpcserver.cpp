...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop GiveHope server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "GiveHope server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* HOPC features */
        {"givehope", "masternode", &masternode, true, true, false},
        {"givehope", "masternodelist", &masternodelist, true, true, false},
        {"givehope", "mnbudget", &mnbudget, true, true, false},
        {"givehope", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"givehope", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"givehope", "mnsync", &mnsync, true, true, false},
        {"givehope", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        {"givehope", "Darksend", &Darksend, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use givehoped, or the -server option to givehope-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
                                               ...
                                               "for example: alertnotify=echo %%s | mail -s \"GiveHope Alert\" admin@foo.com\n"),
...
{
    return "> givehope-cli " + methodname + " " + args + "\n";
}
